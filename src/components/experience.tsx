...
export default function Experience() {
  return (
    <section className="2xl:px-40 px-5 md:px-20 max-sm:pt-10 max-sm:pb-32 md:py-32 lg:py-42">
      ...
      <div className="grid xl:grid-cols-3 gap-y-32 md:gap-y-60 gap-x-20 2xl:gap-x-40">
        ...
        <div className="relative shadow-lg p-10 xl:py-20 border border-(--accent)/20">
          <Image
            ...
            alt=""
            className="absolute top-0 right-0 w-40 h-40 pointer-events-none -translate-y-1/2 max-sm:translate-x-1/5 -translate-x-1/8"
            width={256}
            height={256}
          />
          <div className="relative z-10 pr-6">
