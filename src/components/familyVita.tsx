    ...
    <div className="mx-auto mb-40">
      <div className="flex items-center w-full justify-center">
        <Image
          ...
          alt="Portrait"
          className="object-cover w-4/5 xl:w-2/3 h-full rounded-t-lg"
          width={800}
          height={600}
        />
      </div>
      <div className="w-4/5 xl:w-2/3 bg-(--ultralight-accent) mx-auto rounded-b-lg">
        <ul className="mx-5 md:mx-20 lg:mx-auto lg:w-2/3 2xl:w-1/2 text-gray-800 flex justify-center h-full flex-col">
          ...
          <li className="py-10 my-0 grid grid-cols-[auto_1fr] gap-x-4">
            ...
            Promovierter Sozialwissenschaftler und Referent im höheren Dienst
